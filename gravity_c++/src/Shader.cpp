...
Shader::Shader()
{
    ...
    //programsCourant = new QGLShaderProgram();
    programsCourant.addShaderFromSourceCode(QGLShader::Vertex, ":/coloringVertexShader.vsh"); // Les shaders sont classes par ordre alphabetique v>f
    programsCourant.addShaderFromSourceCode(QGLShader::Fragment, ":/coloringFragmentShader.fsh");
